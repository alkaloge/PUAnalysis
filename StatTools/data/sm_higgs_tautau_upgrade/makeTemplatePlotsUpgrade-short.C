{
   ...
   TString inFile = "diTauPlots/";
   makeDiTauStack(outFile+"diTau_mvis_vbf",inFile+"diTau_m_vis.root","tt_vbf",3,"m_{vis}","GeV",false,"#tau_{h}#tau_{h}","Golden",false,false,true);
