...
TTanalysisConfigurator.addSelector('diTausDecayFound' ,'PATDiTauPairSelector','abs(leg1.userFloat("taudZ"))<0.1&&leg1.tauID("decayModeFinding")>0.5&&abs(leg2.userFloat("taudZ"))<0.1&&leg2.tauID("decayModeFinding")>0.5','TTTauDecayFound',1)
